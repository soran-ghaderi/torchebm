...
| Objective | How is the model fit to data? | `torchebm.losses` | [Learning Objectives](objectives.md) |
...
[Design and Scope](design.md) states the unifying abstraction precisely and
places EBMs, score-based and diffusion models, flow matching, stochastic
interpolants, and Schrödinger bridges in one taxonomy, with references.
