...
| ---------------------------------------------------------------------------------------------------- | -------------------------------- | ----------------------------- | --------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------ |
| MCMC-trained EBMs[1](#fn:hinton)[5](#fn:du)                                                          | energy                           | none                          | none                                                | contrastive family (e.g. CD, persistent CD)             | MCMC                                             |
| Score-based EBMs[2](#fn:hyvarinen)[3](#fn:vincent)[4](#fn:song-ermon)                                | energy                           | fixed or annealed noise       | none                                                | score matching family                                   | annealed Langevin                                |
| Denoising diffusion[6](#fn:ho)[7](#fn:song-sde)                                                      | score or noise                   | variance-preserving schedules | independent                                         | denoising regression over (t)                           | reverse SDE or probability-flow ODE              |
| Flow matching[8](#fn:lipman)[11](#fn:tong)[9](#fn:liu)                                               | velocity                         | simple paths (e.g. linear)    | independent or OT-based (e.g. minibatch OT, reflow) | conditional path regression                             | ODE                                              |
| Stochastic interpolants[10](#fn:albergo)                                                             | velocity (+ score)               | any (\\alpha, \\sigma)        | any                                                 | interpolant regression                                  | ODE or SDE                                       |
| Energy-parameterized transport (e.g. equilibrium matching[12](#fn:eqm), energy matching[13](#fn:em)) | time-independent energy or field | any                           | any, including weighted OT                          | path regression, optionally with contrastive refinement | few-step ODE or a single annealed Langevin sweep |
| Schrödinger bridges[14](#fn:debortoli)                                                               | forward and backward drifts      | diffusion bridge              | iterative proportional fitting                      | bridge matching                                         | SDE (roadmap)                                    |
