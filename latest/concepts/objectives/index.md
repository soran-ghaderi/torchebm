...
The modern objectives replace the inner sampling loop with regression along an interpolant path (see [Interpolants and Couplings](https://soran-ghaderi.github.io/torchebm/latest/concepts/transport/index.md)).
