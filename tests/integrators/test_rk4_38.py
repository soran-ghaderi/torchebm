"""Tests for RK438Integrator (Kutta's 3/8-rule RK4)."""
...
def test_rk438_exponential_decay_numerical():
    ...
    # 4th-order accurate: error vs exp(-h) is O(h^5) ~ 1e-5
...
def test_rk438_vs_rk4_same_order():
    ...
    # Both 4th-order methods should agree very closely on a smooth problem
